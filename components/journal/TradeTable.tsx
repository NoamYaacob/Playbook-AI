...
export function TradeTable({
  ...
  if (trades.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-20 text-center">
        ...
        <h3 className="text-slate-300 font-medium text-lg">No trades found</h3>
  ...
  return (
    <div className={cn("space-y-3", isPending && "opacity-60 pointer-events-none")}>
      {/* ── Bulk actions bar ──────────────────────────────────────────────── */}
      {someSelected && (
        <div className="flex items-center gap-3 px-4 py-2.5 rounded-lg bg-indigo-500/10 border border-indigo-500/20">
      ...
      <div className="rounded-xl border border-slate-800 overflow-hidden">
        <div className="overflow-x-auto">
          <Table>
            <TableHeader>
              <TableRow className="border-slate-800 hover:bg-transparent bg-slate-900/70">
              ...
              {trades.map((trade) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Date/Time */}
                    <TableCell className="text-xs text-slate-300 whitespace-nowrap font-mono">
                    ...
                    {/* Size */}
                    <TableCell className="hidden md:table-cell text-xs font-mono text-slate-300">
                    ...
                    {/* Setup type */}
                    <TableCell className="hidden lg:table-cell text-xs text-slate-400 max-w-[120px] truncate">
