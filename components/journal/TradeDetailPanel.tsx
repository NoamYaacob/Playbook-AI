...
function formatTradeDateTime(value: Date | string): string {
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-slate-100">
      <div className="mx-auto max-w-7xl px-4 py-6 md:px-8 md:py-8">
        ...
        <button
          onClick={() => router.back()}
          className="mb-6 inline-flex items-center gap-1.5 rounded-xl border border-slate-800 bg-slate-900/70 px-3 py-2 text-sm text-slate-400 transition-colors hover:border-slate-700 hover:text-slate-200"
        >
          <ArrowLeft className="h-4 w-4" />
          Back to Journal
        </button>

        <div className="grid grid-cols-1 items-start gap-7 lg:grid-cols-[1fr_420px]">
          {/* ================================================================
              LEFT COLUMN
          ================================================================ */}
          <div className="space-y-6 min-w-0">
            {/* Trade header */}
            <Card className="border-slate-800/80 bg-slate-900/65 shadow-[0_18px_42px_rgba(2,6,23,0.24)]">
              <CardContent className="space-y-5 px-5 py-5 sm:px-6">
                ...
                <div className="flex items-start justify-between gap-4 flex-wrap">
                  ...
                  {/* PnL hero */}
                  <div className="shrink-0 rounded-2xl border border-slate-800/80 bg-slate-950/50 px-4 py-3 text-right">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex flex-wrap gap-4 text-xs text-slate-400">
                  <span className="flex items-center gap-1">
                    ...
                    Entry: {formatTradeDateTime(trade.entryAt)}
                  </span>
                  {trade.exitAt && (
                    <span className="flex items-center gap-1">
                      <Clock className="h-3.5 w-3.5" />
                      Exit: {formatTradeDateTime(trade.exitAt)}
                    </span>
                  )}
                </div>
              </CardContent>
            ...
            {trade.riskViolations && trade.riskViolations.length > 0 && (
              <Card className="border-rose-500/25 bg-rose-950/30">
                <CardHeader className="pb-2">
          ...
          <div className="space-y-4 lg:sticky lg:top-6">
            <div className="rounded-2xl border border-slate-800/80 bg-slate-900/70 p-1.5 shadow-[0_18px_40px_rgba(2,6,23,0.22)]">
              <div className="border-b border-slate-800/80 px-4 pb-3 pt-4">
                <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-500">
                  Reflection
                </p>
                <h2 className="mt-1 text-sm font-semibold text-slate-100">Trade Reflection</h2>
