...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-9 w-full items-center justify-between whitespace-nowrap rounded-md border border-[var(--input)] bg-transparent px-3 py-2 text-sm text-[var(--foreground)] shadow-sm",
...
>(({ className, children, style, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    style={{ paddingInlineStart: "0.5rem", paddingInlineEnd: "2rem", ...style }}
    {...props}
  >
    <span className="absolute flex h-3.5 w-3.5 items-center justify-center" style={{ insetInlineEnd: "0.5rem" }}>
