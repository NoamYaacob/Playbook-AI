      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="relative max-w-xs flex-1">
          ...
          <Input
            ...
            className="bg-slate-800 border-slate-700 text-slate-100 placeholder:text-slate-500 focus:border-indigo-500 focus:ring-indigo-500"
            style={{ paddingInlineStart: "2.25rem", paddingInlineEnd: search ? "2.25rem" : undefined }}
          />
          {search && (
            <button
              type="button"
