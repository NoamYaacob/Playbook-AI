...
export default async function DashboardPage({ searchParams }: PageProps) {
  ...
  return (
    <div className="space-y-7">
      {/* Page header */}
      <Card className="border-slate-800/80 bg-slate-900/70 shadow-[0_18px_48px_rgba(2,6,23,0.28)]">
          ...
          <div className="flex flex-col gap-5 xl:flex-row xl:items-start xl:justify-between">
            <div className="space-y-3">
              <div className="flex flex-wrap items-center gap-2">
                ...
                >
                  {todayComplete ? "Daily review complete" : "Daily review pending"}
                </Badge>
              </div>
              <div>
                ...
                <p className="mt-2 max-w-2xl text-sm leading-relaxed text-slate-400">
                  ...
                  {activeStrategy && (
                    <span className="ml-2 text-slate-500">
                      · Focused on your active playbook and recurring execution patterns.
                    </span>
                  )}
                </p>
              </div>
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
                <div className="rounded-xl border border-slate-800 bg-slate-950/45 px-4 py-3">
                  ...
                  <p className="mt-1 text-sm font-medium text-slate-200">
                    {todayComplete ? "Reflection completed and saved." : "Close the loop with your daily review."}
                  </p>
                </div>
                <div className="rounded-xl border border-slate-800 bg-slate-950/45 px-4 py-3">
                  <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-500">
                  ...
                  <p className="mt-1 text-sm font-medium text-slate-200">
                    {stats.adherenceScore}% adherence across reviewed trades
                  </p>
                </div>
                <div className="rounded-xl border border-slate-800 bg-slate-950/45 px-4 py-3">
                  <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-500">
                  ...
                  <p className="mt-1 text-sm font-medium text-slate-200">
                    {topImprovements[0]?.title ?? "Review your recent trade distribution."}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col items-stretch gap-3 xl:items-end">
              <div className="flex items-center gap-1 rounded-xl border border-slate-700/70 bg-slate-950/45 p-1">
                {(
                  [
                  ...
                  return (
                    <Link
                      ...
                      className={
                        isActive
                          ? "rounded-lg bg-slate-700 px-3 py-1.5 text-xs font-semibold text-slate-100 transition-colors"
                          : "rounded-lg px-3 py-1.5 text-xs font-medium text-slate-400 transition-colors hover:text-slate-200"
                      }
                    >
                      {label}
                    </Link>
      ...
      {/* Daily review prompt */}
      {!todayComplete && (
        <Card className="border-indigo-500/25 bg-gradient-to-r from-indigo-950/50 to-slate-900/60">
          ...
          {stats.recentTrades.length === 0 ? (
            <div className="rounded-2xl border border-dashed border-slate-800 bg-slate-950/40 px-6 py-10 text-center">
              ...
              <p className="mt-1 text-sm text-slate-500">
                Expand the timeframe or import more activity to populate the dashboard.
              </p>
            </div>
          ) : (
