...
export default function AuthLayout({
  ...
  return (
    <div className="min-h-screen flex bg-slate-950">
      ...
      <div
        className="hidden lg:flex lg:w-1/2 xl:w-2/5 flex-col justify-between border-slate-800 bg-gradient-to-br from-slate-900 via-slate-900 to-indigo-950 p-12"
